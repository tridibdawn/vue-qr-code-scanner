      ...
      <tr>
        ...
        <td>
          <span class="table-title">
            <b>#re-registration event</b>
          </span>
          <br />
          <span class="table-desc">
            Made with
            <span class="vue-font">Vue.js</span>
          </span>
        </td>
      </tr>
    </table>
      ...
      <div class="col-md-4">
        <div class="card" style="width: 18rem;">
          ...
          <div class="card-body">
            <p
              class="card-text"
            >Please scan the qrcode event registration that we have sent via your email.</p>
            <hr />
            <div class="alert" :class="alert" role="alert">{{ status }}</div>
          </div>
        </div>
      </div>
    </div>
  ...
  methods: {
    ...
    async onInit(promise) {
      try {
        ...
        let audio = await new Audio(
          "http://soundbible.com/mp3/Industrial Alarm-SoundBible.com-1012301296.mp3"
        );
        audio.play();
